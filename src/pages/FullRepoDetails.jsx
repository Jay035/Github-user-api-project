...
export default function FullRepoDetails({ items }) {
  ...
  return (
    <>
      <Link to="/" className="flex items-center p-3 rounded text-lg transition-colors outline-none text-white bg-[#2bc070] w-fit hover:bg-[#2bc070]/50">
    ...
    <div className="flex flex-col justify-center items-center h-[80vh]">
      {items &&
        items
          ...
          .map((repo, index) => (
            <section key={index} className="bg-[#282a2e] w-full max-w-[700px] mx-auto p-4 rounded-lg text-base flex flex-col gap-6">
